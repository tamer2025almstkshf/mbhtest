<?php
    ...
    if($_GET['id'] === $myid || $row_permcheck['emp_aperm'] === '1'){
        ...
        && isset($_REQUEST['logout_time']) && $_REQUEST['logout_time'] !== ''){
            ...
            $query = "INSERT INTO user_logs (user_id, login_day, login_date, login_time, late_login, logout_day, logout_date, logout_time, early_logout) 
            VALUES ('$user_id', '$login_day', '$login_date', '$login_time', '$late_login', '$logout_day', '$logout_date', '$logout_time', '$early_logout')";
