                    ...
                    <div class="table-container">
                                ...
                                <div id="addclient-btn" class="modal-overlay" <?php if(isset($_GET['addmore']) && $_GET['addmore'] === '1'){ echo 'style="display: block;"'; }?>>
                                    <div class="modal-content">
                                        <div class="addc-header">
                                            <h4 class="addc-header-parag" style="margin: auto">ايرادات جديدة</h4>
                                            ...
                                            <div class="addc-body">
                                                <div class="addc-body-form">
                                                    <div class="input-container" style="border-bottom: 1px solid #00000140">
                                                        <input type="hidden" name="page" value="income.php">
                                                        <input type="hidden" name="ie_type" value="ايرادات">
                                                    ...
                                                    <?php } if((isset($_GET['SearchBy']) && $_GET['SearchBy'] !== '') && ((isset($_GET['Fno']) && $_GET['Fno'] !== '') || (isset($_GET['Mname']) && $_GET['Mname'] !== ''))){?>
                                                        <table class="info-table" style="max-width: 100%; height: 400px overflow: visible; margin-top: 10px">
                                                            ...
                                                            ?>
                                                            <tr class="infotable-body" onclick="location.href='income.php?subcat_id=<?php echo $getsubcatid;?>&SearchBy=FileNo&Fno=<?php echo $rowr['file_id'];?>&addmore=1';">
                                                                <td>
                                                                    <?php 
                                ...
                                <div class="modal-overlay" <?php if(isset($_GET['attachments']) && $_GET['attachments'] === '1'){ echo 'style="display: block;"'; }?>>
                                    <div class="modal-content" style="margin: auto; align-content: center">
                                        <div class="notes-displayer">
                                            <div class="addc-header">
                                                <h4 class="addc-header-parag" style="margin: auto">مرفقات الايرادات</h4>
                                                <div class="close-button-container">
                                                    <p class="close-button" onclick="location.href='income.php';" style="display: inline-block">&times;</p>
                                                </div>
                                            </div>
                                            <div class="notes-body" style="padding: 10px; text-align: right;">
                                                ...
                                                <div class="attachment-row">
                                                    ...
                                                    <div class="perms-check" onclick="location.href='ieattachdel.php?id=<?php echo $rowatt['id'];?>&del=attach_file1&page=income.php';" style="background-image: url('img/recycle-bin.png'); cursor: pointer;"></div>
                                                    <?php }?>
                                                </div>
                                                ...
                                                <div class="attachment-row">
                                                    ...
                                                    <?php if($row_permcheck['accrevenues_aperm'] === '1'){?>
                                                    <div class="perms-check" onclick="location.href='ieattachdel.php?id=<?php echo $rowatt['id'];?>&del=attach_file2&page=income.php';" style="background-image: url('img/recycle-bin.png'); cursor: pointer;"></div>
                                                    <?php }?>
                                                </div>
                                                ...
                                                <div class="attachment-row">
                                                    ...
                                                    <?php if($row_permcheck['accrevenues_aperm'] === '1'){?>
                                                    <div class="perms-check" onclick="location.href='ieattachdel.php?id=<?php echo $rowatt['id'];?>&del=attach_file3&page=income.php';" style="background-image: url('img/recycle-bin.png'); cursor: pointer;"></div>
                                                    <?php }?>
                                                </div>
                                                <?php }?>
                                            </div>
                        ...
                        <div class="table-body">
                            <form action="ie_del.php" method="post">
                                <table class="info-table" id="myTable" style="width: 100%;">
                                        ...
                                        <tr style="height: 30px;">
                                            ...
                                            <td align="center" colspan="3">
                                                ...
                                                ( <font color="#FF0000" style="font-size:20px">
                                                    <?php
                                                        $total_amounts = 0;
                                                        $querytamounts = "SELECT * FROM incomes_expenses WHERE ie_type='ايرادات'";
                                                        ...
                                                        $total_cheques = 0;
                                                        $querytcheques = "SELECT * FROM cheques WHERE ie_type='ايرادات'";
                                    ...
                                    <?php
                                        ...
                                        $query = "SELECT * FROM incomes_expenses WHERE ie_type='ايرادات'$where";
                                    ...
                                    <tbody id="table1">
                                        <tr class="infotable-body">
                                            <td class="options-td" style="background-color: #fff;" width="50px">
                                                ...
                                                <div class="dropdown">
                                                    <?php 
                                                        if($row_permcheck['accrevenues_dperm'] === '1'){
                                                    ?>
                                                    <button type="button" onclick="location.href='deleterevenue.php?id=<?php echo $row['id'];?>';">حذف</button>
                                                    <?php }?>
                                                    <button type="button" onclick="location.href='income.php?attachments=1&id=<?php echo $row['id'];?>';">المرفقات</button>
                                                </div>
                                            </td>
                            ...
                            <div class="table-footer">
                                <?php if($row_permcheck['accrevenues_dperm'] === '1'){?>
