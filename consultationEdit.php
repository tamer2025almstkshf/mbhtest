                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <tr>
                            <td align="center" dir="rtl">
                                <div id="PrintMainDiv">
                                    <form action="consedit.php" method="post" enctype="multipart/form-data" >
                                                                        ...
                                                                        <tr>
                                                                            <th align="right"  dir="rtl"> 
                                                                                <select name="cons_type">
                                                                                    <option value="مدفوعة" <?php if($row12['cons_type'] === 'مدفوعة'){ echo 'selected'; }?>>مدفوعة</option>
                                                                                    <option value="غير مدفوعة" <?php if($row12['cons_type'] === 'غير مدفوعة'){ echo 'selected'; }?>>غير مدفوعة</option>
                                                                                </select>
                                                                            </th>
                                                                            <th align="left"  dir="rtl">نوع الاستشارة :</th>
                                                                        </tr>
                                                                        
                                                                        <tr >
                                                                            <th colspan="2">
                                                                                <?php $id = $_GET['id'];?>
                                                                                <input type="button" value=" افراغ الحقول" onClick="location.href='consultationEdit.php?id=<?php echo $id;?>';" class="button"> 
                                                ...
                                                <table width="100%"  border="0" cellspacing="1" cellpadding="1" class="table" dir="ltr">
                                                    <form action="consdel.php" method="post">
                                                        ...
                                                        <tr  class="header_table">
                                                            ...
                                                            <th width="7%" dir="ltr">نوع الاستشارة</th>
                                                        ...
                                                        <tbody id="table1">
                                                            <?php
                                                                $query_conss = "SELECT * FROM consultations WHERE type='consultation'";
                                                            ...
                                                            <tr valign="top" bgcolor="#ffffff" onMouseOver="bgColor='#eaeaea'" onMouseOut="bgColor='#ffffff'">
                                                                ...
                                                                <th class="reg"  >
                                                                    <?php
                                                                        if($row_permcheck['cons_eperm'] === '1'){
                                                                    ?>
                                                                    <img src="images/Edit.png"  border="0" onClick="location.href='consultationEdit.php?id=<?php echo $row_conss['id'];?>';"  title="اضغط هنا للتعديل" style="cursor:pointer" />
                                                                    <?php }?>
                                                                </th>
                                                                <th ><?php if(isset($row_conss['cons_type']) && $row_conss['cons_type'] !== ''){ echo $row_conss['cons_type']; }?></th>
