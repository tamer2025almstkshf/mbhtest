<?php
    ...
    if($row_permcheck['userattendance_aperm']){
        ...
        (isset($_REQUEST['louttHH']) && $_REQUEST['louttHH'] !== '' || isset($_REQUEST['louttMM']) && $_REQUEST['louttMM'] !== '')){
            ...
            $stmt->bind_param("issssssss", $user_id, $login_day, $login_date, $login_time, $late_login, $logout_day, $logout_date, $logout_time, $early_logout);
            $stmt->execute();
            $stmt->close();
