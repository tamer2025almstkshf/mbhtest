                    ...
                    <div class="table-container">
                        <div class="table-header">
                            ...
                            <div class="table-header-right">
                                <h3 style="display: inline-block"><font id="clients-translate">قبول الاجازات</font></h3>
                            </div>
                        </div>
                        <div class="table-body">
                            ...
                            <table class="info-table" id="myTable" style="width: 100%">
                                ...
                                <?php
                                    $use = $_SESSION['id'];
                                    $stmt_vacs = $conn->prepare("SELECT * FROM vacations WHERE ask2=?");
                                    $one = 1;
                                ...
                                <tbody id="table1">
                                    <tr class="infotable-body">
                                        ...
                                        <td align="center">
                                            ...
                                            <div class="perms-check" style="cursor:pointer; background-image: url('img/verification.png');" onClick="location.href='vacstatus2.php?id=<?php echo safe_output($row_vacs['id']) . '&status=yes';?>';"></div>
                                            <?php }?>
                                        </td>
                                        <td align="center">
                                            <?php if($row_permcheck['vacl_aperm'] == 1){?>
                                            <div class="perms-check" style="cursor:pointer; background-image: url('img/remove.png');" onClick="location.href='vacstatus2.php?id=<?php echo safe_output($row_vacs['id']) . '&status=no';?>';"></div>
                                            <?php }?>
                                        </td>
                                    </tr>
                                </tbody>
