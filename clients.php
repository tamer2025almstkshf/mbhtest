                        ...
                        <div class="table-header">
                            <form action="changetype.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="table-header-right">
                                    <h3 style="display: inline-block"><font id="clients-translate">العملاء</font></h3>
                            ...
                            <div class="table-header-left">
                                ...
                                <?php
                                    ...
                                    if($row_permcheck['clients_aperm'] == 1 || $row_permcheck['clients_eperm'] == 1){
                                ?>
                                    ...
                                    <div class="modal-content">
                                        <div class="addc-header">
                                            ...
                                            <div class="close-button-container">
                                                <p class="close-button" onclick="<?php if(isset($_GET['edit']) && $_GET['edit'] === '1'){ echo "location.href='clients.php';"; } else{ echo 'addclient()'; }?>">&times;</p>
                                            </div>
                                        </div>
                                        <?php
                                        ...
                                        <form action="<?php if(isset($_GET['edit']) && $_GET['edit'] === '1'){ echo 'cedit.php'; } else{ echo 'cadd.php'; }?>" method="post" enctype="multipart/form-data" >
                                            <input type="hidden" name="timermainid" value="<?php if(isset($_GET['edit']) && $_GET['edit'] === '1'){ echo safe_output($id); } else { echo safe_output($cid); }?>">
                                            <input type="hidden" name="timersubinfo" value="<?php echo $cid;?>">
                                            <input type="hidden" name="timeraction" value="<?php if(isset($_GET['edit']) && $_GET['edit'] === '1'){ echo 'client_edit'; } else { echo 'client_add'; }?>">
                                            <input type="hidden" name="timerdone_date" value="<?php echo date("Y-m-d");?>">
                                            <input type="hidden" name="timerdone_action" value="<?php if(isset($_GET['edit']) && $_GET['edit'] === '1'){ echo 'تعديل بيانات العميل رقم '.$cid; } else { echo 'ادخال بيانات العميل رقم '.$cid; }?>">
                                            ...
                                            <div class="addc-body">
                                                <div class="addc-body-form">
                                                    ...
                                                    <div class="input-container">
                                                        ...
                                                        <input type="radio" name="terror" value="1" style="padding: 10px 0; margin: 10px 0;" <?php if(isset($_GET['edit']) && $_GET['edit'] === '1' && $erow['terror'] == 1){ echo 'checked'; }?>> نعم <br>
                                                        <input type="radio" name="terror" value="0" <?php if(isset($_GET['edit']) && $_GET['edit'] === '1'){ if($erow['terror'] == 0){ echo 'checked'; }} else{ echo 'checked'; }?>> لا
                                                    </div>
                                                    <div class="input-container">
                                                    ...
                                                    <div class="moreinps-container">
                                                        ...
                                                        <div class="moreinps-content" id="contactInfo" id="fileUploadSection">
                                                            ...
                                                            <div class="input-container">
                                                                <h4 class="input-parag" style="padding-bottom: 10px;">
                                                                    <img src="img/menu-bar.png" width="20px" height="20px" title="اضافة مرفقات" onclick="toggleMore()" align="absmiddle" style="cursor:pointer">
                                                                    مرفقات أخرى
                                                                </h4>
                                                                ...
                                                                <div id="toggle-more" style="display: none;">
                                                    ...
                                                    <div class="moreinps-container">
                                                        ...
                                                        <div class="moreinps-content" id="contactInfo" id="fileUploadSection">
                                                            ...
                                                            <div class="input-container">
                                                                ...
                                                                <input class="form-input" value="<?php if(isset($_GET['edit']) && $_GET['edit'] === '1'){ echo $erow['id']; } else{ echo $cid; }?>" type="text" disabled>
                                                                <input type="hidden" name="cid" value="<?php if(isset($_GET['edit']) && $_GET['edit'] === '1'){ echo $erow['id']; } else{ echo $cid; }?>">
                                                            </div>
                                                            <?php 
                                                                if(!isset($_GET['edit']) || $_GET['edit'] !== '1'){
                                                            ?>
                                            ...
                                            <div class="addc-footer">
                                                <button 
                                                style="cursor: <?php if(isset($_GET['edit']) && $_GET['edit'] === '1'){ if($row_permcheck['clients_eperm'] == 1){ echo 'pointer'; } else{ echo 'not-allowed'; }} else{ if($row_permcheck['clients_aperm'] == 1){ echo 'pointer'; } else{ echo 'not-allowed'; }}?>" 
                                                type="<?php if(isset($_GET['edit']) && $_GET['edit'] === '1'){ if($row_permcheck['clients_eperm'] == 1){ echo 'submit'; } else{ echo 'button'; }} else{ if($row_permcheck['clients_aperm'] == 1){ echo 'submit'; } else{ echo 'button'; }}?>" 
                                                ...
                                                <button type="button" class="form-btn cancel-btn" onclick="<?php if(isset($_GET['edit']) && $_GET['edit'] == 1){ echo "location.href='clients.php';"; } else{ echo 'addclient()'; }?>">الغاء</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                    ...
                                    <div class="modal-content" style="margin: auto; align-content: center">
                                        <div class="notes-displayer">
                                            <div class="addc-header">
                                                ...
                                                <div class="close-button-container">
                                                    <p class="close-button" onclick="location.href='clients.php';" style="display: inline-block">&times;</p>
                                                </div>
                                            </div>
                                            <div class="notes-body" style="padding: 10px; text-align: right;">
                                                ...
                                                <div class="attachment-row">
                                                    ...
                                                    <div class="perms-check" onclick="location.href='cattachdel.php?id=<?php echo $rowatt['id'];?>&del=passport&page=clients.php';" style="background-image: url('img/recycle-bin.png'); cursor: pointer;"></div>
                                                    <?php }?>
                                                </div>
                                                <?php
                                                    }
                                                ...
                                                <div class="attachment-row">
                                                    ...
                                                    <?php if($row_permcheck['clients_eperm'] == 1){?>
                                                    <div class="perms-check" onclick="location.href='cattachdel.php?id=<?php echo $rowatt['id'];?>&del=id_file&page=clients.php';" style="background-image: url('img/recycle-bin.png'); cursor: pointer;"></div>
                                                    <?php }?>
                                                </div>
                                                <?php
                                                    }
                                                ...
                                                <div class="attachment-row">
                                                    ...
                                                    <?php if($row_permcheck['clients_eperm'] == 1){?>
                                                    <div class="perms-check" onclick="location.href='cattachdel.php?id=<?php echo $rowatt['id'];?>&del=auth&page=clients.php';" style="background-image: url('img/recycle-bin.png'); cursor: pointer;"></div>
                                                    <?php }?>
                                                </div>
                                                <?php
                                                    }
                                                ...
                                                <div class="attachment-row">
                                                    ...
                                                    <?php if($row_permcheck['clients_eperm'] == 1){?>
                                                    <div class="perms-check" onclick="location.href='cattachdel.php?id=<?php echo $rowatt['id'];?>&del=attach1&page=clients.php';" style="background-image: url('img/recycle-bin.png'); cursor: pointer;"></div>
                                                    <?php }?>
                                                </div>
                                                <?php
                                                    }
                                                ...
                                                <div class="attachment-row">
                                                    ...
                                                    <?php if($row_permcheck['clients_eperm'] == 1){?>
                                                    <div class="perms-check" onclick="location.href='cattachdel.php?id=<?php echo $rowatt['id'];?>&del=attach2&page=clients.php';" style="background-image: url('img/recycle-bin.png'); cursor: pointer;"></div>
                                                    <?php }?>
                                                </div>
                                                <?php
                                                    }
                                                ...
                                                <div class="attachment-row">
                                                    ...
                                                    <?php if($row_permcheck['clients_eperm'] == 1){?>
                                                    <div class="perms-check" onclick="location.href='cattachdel.php?id=<?php echo $rowatt['id'];?>&del=attach3&page=clients.php';" style="background-image: url('img/recycle-bin.png'); cursor: pointer;"></div>
                                                    <?php }?>
                                                </div>
                                                <?php
                                                    }
                                                ...
                                                <div class="attachment-row">
                                                    ...
                                                    <?php if($row_permcheck['clients_eperm'] == 1){?>
                                                    <div class="perms-check" onclick="location.href='cattachdel.php?id=<?php echo $rowatt['id'];?>&del=attach4&page=clients.php';" style="background-image: url('img/recycle-bin.png'); cursor: pointer;"></div>
                                                    <?php }?>
                                                </div>
                                                <?php
                                                    }
                                                ...
                                                <div class="attachment-row">
                                                    ...
                                                    <?php if($row_permcheck['clients_eperm'] == 1){?>
                                                    <div class="perms-check" onclick="location.href='cattachdel.php?id=<?php echo $rowatt['id'];?>&del=attach5&page=clients.php';" style="background-image: url('img/recycle-bin.png'); cursor: pointer;"></div>
                                                    <?php }?>
                                                </div>
                                                <?php
                                                    }
                                                ...
                                                <div class="attachment-row">
                                                    ...
                                                    <?php if($row_permcheck['clients_eperm'] == 1){?>
                                                    <div class="perms-check" onclick="location.href='cattachdel.php?id=<?php echo $rowatt['id'];?>&del=attach6&page=clients.php';" style="background-image: url('img/recycle-bin.png'); cursor: pointer;"></div>
                                                    <?php }?>
                                                </div>
                                                <?php
                                                    }
                            ...
                            <table class="info-table" id="myTable" style="background-color: #99999940">
                                <thead>
                                    ...
                                    <tr class="infotable-header" style="position: sticky; top: 0; z-index: 3;">
                                        <th style="position: sticky; right: 0; width: 50px;">الكود</th>
                                        <th style="position: sticky; right: 50px;">الإسم</th>
                                        <th>الفئة</th>
                                        <th>التصنيف</th>
                                        <th>بيانات العميل</th>
                                        <th>عدد القضايا</th>
                                ...
                                <?php
                                    $baseQuery = "SELECT * FROM client WHERE client_kind!='' AND arname!='' AND password!='' AND terror!='1'";
                                    if(isset($_GET['type']) && $_GET['type'] !== ''){
                                        $type = $_GET['type'];
                                        if($type === 'clients'){
                                            $stmt = $conn->prepare($baseQuery . " AND client_kind='موكل' ORDER BY id DESC");
                                        } else if($type === 'opponents'){
                                            $stmt = $conn->prepare($baseQuery . " AND client_kind='خصم' ORDER BY id DESC");
                                        } else if($type === 'subs'){
                                            $stmt = $conn->prepare($baseQuery . " AND client_kind='عناوين هامة' ORDER BY id DESC");
                                        } else {
                                ...
                                <tbody id="table1">
                                    <tr class="infotable-body">
                                        <td style="color: #007bff;"><?php echo $row['id'];?></td>
                                        <td style="color: #007bff"><?php echo safe_output($row['arname']); if(isset($row['engname']) && $row['engname'] !== ''){ echo '<br>' . safe_output($row['engname']); }?></td>
                                        <td style="color: #007bff"><?php echo safe_output($row['client_type']);?></td>
                                        <td style="<?php if($row['client_kind'] === 'موكل'){ echo 'color: #5CB85C;'; } else if($row['client_kind'] === 'خصم'){ echo 'color: red;'; } else{ echo 'color: #007bff;'; }?>"><?php echo safe_output($row['client_kind']);?></td>
                                        <td>
                                            <?php if(isset($row['country']) && $row['country'] !== ''){?>
                                            <p>
                                                <b>الجنسية : </b>
                                                <?php echo safe_output($row['country']);?>
                                            </p>
                                            <?php } if(isset($row['address']) && $row['address'] !== ''){?>
                                            <p>
                                                <b>العنوان : </b>
                                                <?php echo safe_output($row['address']);?>
                                            </p>
                                            <?php } if(isset($row['tel1']) && $row['tel1'] !== ''){?>
                                            <p>
                                                <b>الهاتف 1 : </b>
                                                <?php echo safe_output($row['tel1']);?>
                                            </p>
                                            <?php } if(isset($row['tel2']) && $row['tel2'] !== ''){?>
                                            <p>
                                                <b>الهاتف 2 : </b>
                                                <?php echo safe_output($row['tel2']);?>
                                            </p>
                                            <?php } if(isset($row['email']) && $row['email'] !== ''){?>
                                            <p>
                                                <b>البريد الالكتروني : </b>
                                                <?php echo safe_output($row['email']);?>
                                            </p>
                                            <?php } if(isset($row['fax']) && $row['fax'] !== ''){?>
                                            <p>
                                                <b>الفاكس : </b>
                                                <?php echo safe_output($row['fax']);?>
                                            </p>
                                            <?php }?>
                                        </td>
                                        <td <?php if($row_permcheck['cfiles_rperm'] == 1){?>style="cursor: pointer" onclick="MM_openBrWindow('clientcases.php?id=<?php echo $row['id'];?>','','resizable=yes,status=no,location=no,toolbar=no,menubar=no,fullscreen=no,scrollbars=no,width=800,height=800')" <?php }?>>
                                            متداولة : 
                                            <?php
                                                $cid = $row['id'];
                                                $stmt2 = $conn->prepare("SELECT COUNT(*) as iacount FROM file WHERE (file_client = ? OR file_client2 = ? OR file_client3 = ? OR file_client4 = ? OR file_client5 = ?) AND file_status = 'متداول'");
                                                $stmt2->bind_param("iiiii", $cid, $cid, $cid, $cid, $cid);
                                                $stmt2->execute();
                                                $result_iacount = $stmt2->get_result();
                                                $row_iacount = $result_iacount->fetch_assoc();
                                            ...
                                            <?php
                                                $cid = $row['id'];
                                                $stmt3 = $conn->prepare("SELECT COUNT(*) as iacount FROM file WHERE (file_client = ? OR file_client2 = ? OR file_client3 = ? OR file_client4 = ? OR file_client5 = ?) AND file_status = 'في الإنتظار'");
                                                $stmt3->bind_param("iiiii", $cid, $cid, $cid, $cid, $cid);
                                                $stmt3->execute();
                                                $result_iacount = $stmt3->get_result();
                                                $row_iacount = $result_iacount->fetch_assoc();
                                                $iacount = $row_iacount['iacount'];
                                                $stmt3->close();
                                            ...
                                            <?php
                                                $cid = $row['id'];
                                                $stmt4 = $conn->prepare("SELECT COUNT(*) as iacount FROM file WHERE (file_client = ? OR file_client2 = ? OR file_client3 = ? OR file_client4 = ? OR file_client5 = ?) AND file_status = 'منتهي'");
                                                $stmt4->bind_param("iiiii", $cid, $cid, $cid, $cid, $cid);
                                                $stmt4->execute();
                                                $result_iacount = $stmt4->get_result();
                                                $row_iacount = $result_iacount->fetch_assoc();
                                                $iacount = $row_iacount['iacount'];
                                                $stmt4->close();
                                                ...
                                                echo $iacount;
                                            ?>
                                        <td <?php if($row_permcheck['clients_eperm'] == 1){?> style="cursor: pointer;" onclick="confirmPassChange(<?php echo $row['id'];?>)" <?php }?>><?php echo safe_output($row['password']);?></td>
                                        <td>
                                            <?php if($row_permcheck['clients_eperm'] == 1){?>
                                            <img src="img/edit.png" style="cursor: pointer;" title="تعديل" height="20px" width="20px" onclick="location.href='clients.php?edit=1&id=<?php echo $row['id'];?>';">
                                            <?php }?>
                                            <img src="img/attachments.png" style="cursor: pointer;" title="المرفقات" height="20px" width="20px" onclick="location.href='clients.php?attachments=1&id=<?php echo $row['id'];?>';">
                                            <img src="<?php if($row['perm'] == 1){ echo 'img/verification.png'; } else{ echo 'img/remove.png'; }?>" style="cursor: pointer;" title="صلاحية الدخول" height="20px" width="20px" <?php if($row_permcheck['clients_eperm'] == 1){?> onclick="confirmPerm(<?php echo $row['id'];?>)" <?php }?>>
                                            <img src="img/actions.png" style="cursor: pointer;" title="الملاحظات" height="20px" width="20px" onclick="checknotes(<?php echo $row['id']; ?>);">
                                            <div id="checknotes-btn-<?php echo $row['id']; ?>" class="modal-overlay">
                                                <div class="modal-content" style="margin: auto; align-content: center">
                                                    <div class="notes-displayer">
                                                        ...
                                                        <div class="notes-body" style="padding: 10px; text-align: right;">
                                                            <?php echo safe_output($row['notes']);?>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
