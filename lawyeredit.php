<?php
    ...
    if($row_permcheck['emp_perms_edit'] === '1'){
        if(isset($_REQUEST['name']) && $_REQUEST['name'] !== '' && isset($_REQUEST['tel_no']) && $_REQUEST['tel_no'] !== ''){
            ...
            $queryr = "SELECT * FROM lawyers WHERE id='$id'";
            ...
            if (isset($_FILES['attachment2']) && $_FILES['attachment2']['error'] == 0) {
                ...
                if (move_uploaded_file($_FILES['attachment2']['tmp_name'], $attachment2)) {
                    ...
                    echo "Sorry, there was an error uploading Photo 2.<br>";
                }
            }
            ...
            if($submit_back === 'addmore'){
                header("Location: Lawyers.php?lawyeredited=1&addmore=1");
            } else{
                header("Location: Lawyers.php?lawyeredited=1");
            }
            exit();
        } else{
