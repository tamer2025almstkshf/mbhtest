                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form action="<?php if(isset($_GET['edit']) && $_GET['edit'] === '1'){ echo 'editbankacc.php'; } else{ echo 'bankacc.php'; }?>" method="post" enctype="multipart/form-data" >
                                            ...
                                            <div class="addc-footer">
                                                ...
                                                type="<?php if(isset($_GET['edit']) && $_GET['edit'] === '1'){ if($row_permcheck['accbankaccs_eperm'] ==''){ echo 'submit'; } else{ echo 'button'; }} else{ if($row_permcheck['accbankaccs_aperm'] == 1){ echo 'submit'; } else{ echo 'button'; }}?>" 
